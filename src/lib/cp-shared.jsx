...
export const TagBadge = ({tag, size="sm"}) => {
  ...
  return (
    <span style={{fontSize:size==="sm"?9:10, background:tc.bg, color:tc.c,
      ...
      fontFamily:"var(--font-dm-mono),monospace", fontWeight:500, whiteSpace:"nowrap"}}>{tag}</span>
  );
};
      ...
      <div style={{height:photoH, position:"relative", overflow:"hidden",
        ...
        {hasValidTicker && (
          <div style={{position:"absolute", top:9, left:9, display:"flex", gap:5, zIndex:2}}>
            <span className="cp-tkr" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:10, fontWeight:600, color:"#fff",
              background:"rgba(0,0,0,0.52)", backdropFilter:"blur(6px)",
              padding:"2px 8px", borderRadius:4}}>{n.sym}</span>
            {hasChg && (
              <span className="cp-num" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:10, fontWeight:600,
        ...
        <div style={{position:"absolute", bottom:hero?72:8, right:10, zIndex:2}}>
          <span style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:9,
            ...
            <div style={{display:"flex", gap:5, marginBottom:7, alignItems:"center"}}>
              ...
              {n.mins != null && (
                <span className="cp-num" style={{fontSize:10, color:"rgba(255,255,255,0.65)", marginLeft:"auto",
                  fontFamily:"var(--font-dm-mono),monospace"}}>{timeAgo(n.mins)}</span>
              )}
            </div>
    ...
    <form onSubmit={submit} style={{ position: "relative", display: "flex", alignItems: "center",
      ...
      <input type="text" value={v} onChange={e => setV(e.target.value.toUpperCase())}
        ...
        style={{ width: "100%", height: "100%", background: "transparent", border: "none", outline: "none",
          color: "#1A1A1A", fontFamily: "var(--font-dm-mono),monospace", fontSize: 14, letterSpacing: "0.5px",
  ...
  return (
    <div style={{background:C.white, borderBottom:`1px solid ${C.border}`,
      ...
      {hasData ? (
        <div style={{display:"flex", transform:`translateX(${pos%w}px)`,
          ...
          {[...tickers, ...tickers, ...tickers].map((t, i) => (
            <div key={i} style={{display:"flex", alignItems:"center", gap:6,
              ...
              <span className="cp-tkr" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:11, color:C.muted, fontWeight:400}}>{t.sym}</span>
              <span className="cp-num" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:11, color:C.ink, fontWeight:500}}>
                {t.sym === "BTC" || (t.price > 1000) ? (+t.price).toLocaleString() : fmt2(+t.price)}
              </span>
              <span className="cp-num" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:10,
        ...
        <div style={{padding:"0 16px", fontFamily:"var(--font-dm-mono),monospace",
    ...
    <div style={{background:C.white, border:`1px solid ${C.border}`, borderRadius:8, overflow:"hidden"}}>
      ...
      {loading || !hasData ? Array(6).fill(0).map((_, i) => (
        ...
        <div key={i} className="hov" onClick={() => { if (t.sym && t.sym !== "?") router.push(`/ticker/${encodeURIComponent(t.sym)}`); }}
          ...
          <span className="cp-tkr" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:12, fontWeight:600, color:C.ink}}>{t.sym}</span>
          <div style={{display:"flex", alignItems:"center", gap:7}}>
            <span className="cp-num" style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:12, color:C.text}}>
  ...
  return (
    <>
      <div style={{background:"#0C1410", borderRadius:8, padding:"18px",
        ...
        <div style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:9, color:"#3A6A48",
        ...
        <p style={{fontSize:10, color:"rgba(255,255,255,0.5)", marginTop:6,
          fontFamily:"var(--font-dm-mono),monospace", textAlign:"center"}}>Free forever · No credit card</p>
      </div>
  ...
  return (
    <div style={{background:C.navBg, marginTop:20, padding:"24px",
      ...
      <div style={{display:"flex", alignItems:"center", gap:6,
        fontFamily:"var(--font-dm-mono),monospace", fontSize:10, color:"rgba(255,255,255,0.5)"}}>
