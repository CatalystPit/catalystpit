...
export const FUTURES = {
  ...
  NQ:  { label: 'Nasdaq 100',           tv: 'TVC:NDQ',        cat: 'Index' },
  MNQ: { label: 'Nasdaq 100 (Micro)',   tv: 'TVC:NDQ',        cat: 'Index' },
  ...
  // Energy
  CL:  { label: 'Crude Oil (WTI)',      tv: 'TVC:USOIL',      cat: 'Energy' },
  MCL: { label: 'Crude Oil (Micro)',    tv: 'TVC:USOIL',      cat: 'Energy' },
  BZ:  { label: 'Brent Crude',          tv: 'TVC:UKOIL',      cat: 'Energy' },
  ...
  // Rates (yields)
  US10Y: { label: 'US 10-Year Yield',   tv: 'TVC:US10Y',      cat: 'Rates' },
  US02Y: { label: 'US 2-Year Yield',    tv: 'TVC:US02Y',      cat: 'Rates' },
  US30Y: { label: 'US 30-Year Yield',   tv: 'TVC:US30Y',      cat: 'Rates' },
  // FX (front-month proxied by spot pair)
  '6E': { label: 'Euro / USD',          tv: 'FX:EURUSD',      cat: 'FX' },
  '6B': { label: 'British Pound / USD', tv: 'FX:GBPUSD',      cat: 'FX' },
  '6J': { label: 'USD / Japanese Yen',  tv: 'FX:USDJPY',      cat: 'FX' },
  '6A': { label: 'Aussie / USD',        tv: 'FX:AUDUSD',      cat: 'FX' },
  '6C': { label: 'USD / Canadian',      tv: 'FX:USDCAD',      cat: 'FX' },
  // Crypto
...
export const FUTURES_POPULAR = ['ES', 'NQ', 'YM', 'RTY', 'VIX', 'CL', 'NG', 'GC', 'SI', 'DXY', 'US10Y', 'BTC'];
