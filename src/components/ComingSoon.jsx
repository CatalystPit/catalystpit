    ...
    <div style={{fontFamily:"'DM Sans',sans-serif", background:C.bg, color:C.text, minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:880, margin:"0 auto", padding:"80px 24px 100px",
        ...
        <div style={{display:"inline-flex", alignItems:"center", gap:8,
          ...
          <Dot/>
          <span style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:10, fontWeight:600,
        ...
        {features.length > 0 && (
          <div style={{background:C.white, border:`1px solid ${C.border}`, borderRadius:8,
            ...
            <div style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:9, color:C.muted,
        ...
        <div style={{background:"#0C1410", borderRadius:12, padding:"32px 40px",
          ...
          <div style={{fontFamily:"var(--font-dm-mono),monospace", fontSize:10, color:"#5AB87A",
          ...
          <p style={{fontSize:11, color:"rgba(255,255,255,0.4)", marginTop:14,
            fontFamily:"var(--font-dm-mono),monospace", letterSpacing:"0.5px"}}>
