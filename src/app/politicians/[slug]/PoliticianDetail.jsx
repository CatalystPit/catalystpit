  ...
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: C.bg, color: C.text, minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '20px 24px 40px' }}>
        <a href="/politicians" style={{ fontFamily: "'DM Mono',monospace", fontSize: 12, letterSpacing: '0.8px', color: C.green, textDecoration: 'none' }}>← All politicians</a>
        ...
        {error ? (
          ...
          <>
            ...
            {/* TRADE HISTORY TABLE */}
            <div style={{ fontSize: 12, fontWeight: 400, color: C.dim, fontFamily: "'DM Mono',monospace", letterSpacing: '0.8px', margin: '18px 0 10px' }}>{trades.length} trades</div>
                    ...
                    {trades.length === 0 ? (
                      ...
                      return (
                        <tr key={t.id || i}
                          ...
                          <td style={{ padding: '12px 14px', fontFamily: "'DM Mono',monospace", fontWeight: 400, letterSpacing: '0.8px', fontSize: 11, color: C.muted, whiteSpace: 'nowrap' }}>{fmtDate(t.transactionDate)}</td>
                          <td style={{ padding: '12px 14px', fontFamily: "'DM Mono',monospace", fontWeight: 400, letterSpacing: '0.8px', fontSize: 11, color: C.muted, whiteSpace: 'nowrap' }}>{fmtDate(t.disclosureDate)}</td>
