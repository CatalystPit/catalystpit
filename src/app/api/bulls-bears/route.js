...
// These validators were extracted verbatim into src/lib/grounding.mjs so the external-news
// headline writer enforces the SAME anti-fabrication gate. Equivalence against the previous
// inline implementations is proven by scripts/verify-grounding.mjs (296,967 comparisons, 0
// mismatches). Behaviour here is unchanged.
import { valuesIn, validateBullet } from '../../../lib/grounding.mjs';
