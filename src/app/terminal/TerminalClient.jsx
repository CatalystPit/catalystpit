...
// ⚠️ THE LEGACY PIT SCAN BODY LIVED HERE AND IS GONE. It rendered /api/scan?mode=pit — the old
// weighted signal engine — as a second Pit Scan inside the Terminal, and had been unreachable
// since the panel switched to PitScanPanel: defined, never mounted. Two implementations of one
// product is how the Terminal and /scan eventually disagree about what is on the board, so the
// dead one is removed rather than left as a tempting shortcut. PitScanPanel is the only Pit Scan.
